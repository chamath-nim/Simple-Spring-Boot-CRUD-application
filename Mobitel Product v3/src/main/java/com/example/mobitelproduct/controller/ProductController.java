...
public class ProductController {
    ...
    @GetMapping(commonUrl.findAllHis)
    public ResponseHandler<ProductHisDto> getAllHis(){
        return productService.findAllHistory();
    }

    @GetMapping(commonUrl.findHisByName)
    public ResponseHandler<ProductHisDto> find(@PathVariable("name") String name) {
        return productService.findHisByName(name);
    }
