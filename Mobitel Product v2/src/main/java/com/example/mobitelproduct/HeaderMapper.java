...
public class HeaderMapper {
    ...
    public static void success(ResponseHandler<ProductDto> ptResponse, String extraDescription) {
    ...
    public static void notFoundError(ResponseHandler<ProductDto> ptResponse, String extraDescription){
        ResponseHeader responseHeader = new ResponseHeader();
